  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-navy to-medium-blue rounded-2xl p-8 md:p-16 shadow-2xl text-white">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-gold font-semibold mb-4">Value: ₦10,000</p>
            ...
            <div className="mb-8">
              ...
              <p className="text-gold font-semibold mb-4">Value: ₦100,000</p>
              <p className="text-gray-300 mb-4">
            ...
            <div className="mb-8">
              ...
              <p className="text-gold font-semibold mb-4">Value: ₦50,000</p>
              <p className="text-gray-300 mb-4">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-6">
              For the first 50 people only, you will have the opportunity to gain access to everything by paying <span className="text-gold font-bold">any reasonable amount you can afford</span>.
            </p>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-xl sm:text-2xl font-bold text-gold mb-6 text-center">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-gold mb-8">
              READY?
            </h2>
